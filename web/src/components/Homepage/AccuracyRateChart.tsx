...
const AccuracyRateChart: React.FC<ChartProps> = ({ data, compareDataSets, options, chartType, openModal, markedPoints, setMarkedPoints, isModalOpen }) => {
        ...
        datasets: [
            {
                ...
                hoverBackgroundColor: 'rgba(158, 134, 253)'
            },
            !isComparing && {
                label: 'Average',
                ...
                hoverBackgroundColor: 'rgba(87, 250, 255)',
                borderDash: [10, 5],
                pointRadius: 0,
            },
            {
                ...
                borderColor: 'rgba(92, 210, 78, 0.2)',
                backgroundColor: 'rgba(92, 210, 78, 0.2)',
                hoverBackgroundColor: 'rgba(92, 210, 78)',
                pointRadius: 8,
